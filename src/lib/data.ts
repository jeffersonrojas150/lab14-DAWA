...
export const personalInfo = {
  name: 'Jefferson Rojas Sosa',
  title: 'Full Stack Developer',
  description: 'Desarrollador apasionado por crear experiencias web excepcionales',
  email: 'jeffersonrojassosa150@gmail.com',
  github: 'https://github.com/jeffersonrojas150',
  linkedin: 'https://linkedin.com/in/tuusuario',
  siteUrl: 'https://tuportafolio.com', // Cambia esto si tienes URL real luego
  avatar: '/jefferson_rojas.png',
};